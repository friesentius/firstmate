...
family_for_basename() {
  case "$1" in
    ...
    fm-backend-herdr-project-workspace-e2e.test.sh|\
    ...
    fm-spawn-commit-attribution.test.sh|fm-spawn-dispatch-profile.test.sh|fm-claude-trust.test.sh|\
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    bin/fm-install-actionlint.sh|bin/fm-commit-attribution-scan.sh|\
